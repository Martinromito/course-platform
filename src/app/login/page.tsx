...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fdfaf5] px-5">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 w-1/3 h-1/3 bg-[#e9a68a]/10 blur-[120px]" />
        <div className="absolute bottom-0 right-0 w-1/3 h-1/3 bg-[#b04b2b]/10 blur-[120px]" />
      </div>
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-[#3e2723]">Bienvenida</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-[#d7ccc8] p-6 sm:p-10 rounded-[28px] sm:rounded-[40px] shadow-2xl shadow-[#b04b2b]/5 space-y-5 sm:space-y-6">
          ...
          <p className="text-center text-sm text-[#8d6e63] font-medium">
            ¿No tienes cuenta?{' '}
            <Link href="/register" className="text-[#b04b2b] hover:underline font-bold">
              Regístrate gratis
            </Link>
          </p>
        </form>
